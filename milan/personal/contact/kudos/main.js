/**
 * Nested namespace
 * @namespace milan.personal.contact.kudos
 * @author Milan Adamovsky
 */

 // [Boilerplate Instructions]
 // We use a base class here as a pre-requisite.  This is probably the closest we will get using OOP in our
 // boilerplate.  The main reason we do this is because we know some of our components share logic so this
 // is a mechanism for us to write it only once and share it between components.  Nothing is stopping us
 // from overriding the default behavior.  The beauty of OOP inheritance.
 define([
         "backbone",
         "root/main",
        ...
        function (Backbone, 
                  ...
                  base)
         {
          return root.namespace("personal.contact.kudos",
                                {
                                 ...
                                 "Model" : Backbone.Model.extend({
                                                                  "defaults" : {
                                                                               ...
                                                                               // [Boilerplate Instructions]
                                                                               // Here we can see how we can use the validate() functionality to ensure the content
                                                                               // submitted on a form is proper.  The logic of validate() should be superficial since
                                                                               // the final error validation will occur on the back-end anyway.  This function's
                                                                               // purpose is to minimize the server trips needed and as such improve the user
                                 ...
                                 "Templates" : Backbone.Model.extend({
                                          ...
                                          // [Boilerplate Instructions]
                                          // Notice we use our base class here.                            
